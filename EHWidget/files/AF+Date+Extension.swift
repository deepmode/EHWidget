...
extension Date {
    ...
    // MARK: Components
    fileprivate static func componentFlags() -> NSCalendar.Unit { return NSCalendar.Unit.year.union(NSCalendar.Unit.month).union(NSCalendar.Unit.day).union(NSCalendar.Unit.weekOfYear).union(NSCalendar.Unit.hour).union(NSCalendar.Unit.minute).union(NSCalendar.Unit.second).union(NSCalendar.Unit.weekday).union(NSCalendar.Unit.weekdayOrdinal).union(NSCalendar.Unit.weekOfYear) }
